...
export default function LoginPage({ onSubmit, onGoogleLogin }: LoginPageProps) {
  ...
  return (
    <div className="min-h-screen w-full flex bg-white">
      ...
      <div className="hidden lg:flex lg:w-1/2 relative overflow-hidden bg-gradient-to-br from-sky-600 to-sky-800">
        {/* decorative "track lane" lines — coaching motif */}
      ...
      <div className="flex-1 flex items-center justify-center px-6 py-12">
        <div className="w-full max-w-sm">
          ...
          <form onSubmit={handleSubmit} className="mt-6 space-y-4">
            ...
            <button
              type="submit"
              className="w-full py-2.5 rounded-lg text-white text-sm font-medium transition shadow-sm bg-sky-600 hover:bg-sky-700"
            >
              Đăng nhập
            </button>
          </form>
